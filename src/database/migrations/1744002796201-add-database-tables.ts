...
export class AddDatabaseTables1744002796201 implements MigrationInterface {
    name = 'AddDatabaseTables1744002796201'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`ALUMNO\` (\`id_alumno\` varchar(36) NOT NULL, \`dni_alumno\` char(8) NOT NULL DEFAULT 'xxxxxxxx', \`nombre\` varchar(100) NOT NULL, \`apellido\` varchar(100) NOT NULL, \`fecha_nacimiento\` date NOT NULL, \`direccion\` varchar(100) NOT NULL DEFAULT 'xxxxxxxx', \`codigo_qr\` varchar(100) NOT NULL, \`id_turno\` varchar(36) NULL, \`id_user\` varchar(36) NULL, UNIQUE INDEX \`REL_689a671722194592d4aa04659c\` (\`id_user\`), PRIMARY KEY (\`id_alumno\`)) ENGINE=InnoDB`);
