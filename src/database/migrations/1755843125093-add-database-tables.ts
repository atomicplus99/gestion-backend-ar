...
export class AddDatabaseTables1755843125093 implements MigrationInterface {
    name = 'AddDatabaseTables1755843125093'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`APODERADO_ALUMNO\` ADD CONSTRAINT \`FK_4502f74931d4bfc94c272a02cde\` FOREIGN KEY (\`id_alumno\`) REFERENCES \`ALUMNO\`(\`id_alumno\`) ON DELETE CASCADE ON UPDATE CASCADE`);
    }
