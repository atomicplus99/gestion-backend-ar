...
export class Migration1766054798883 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`notificaciones\` CHANGE \`icono\` \`icono\` varchar(50) NULL`);
        await queryRunner.query(`ALTER TABLE \`notificaciones\` DROP COLUMN \`detalles\``);
        await queryRunner.query(`ALTER TABLE \`notificaciones\` ADD \`detalles\` json NULL`);
        await queryRunner.query(`ALTER TABLE \`notificaciones\` CHANGE \`fecha_creacion\` \`fecha_creacion\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE \`notificaciones\` CHANGE \`fecha_lectura\` \`fecha_lectura\` timestamp NULL`);
        await queryRunner.query(`ALTER TABLE \`notificaciones\` CHANGE \`fecha_archivado\` \`fecha_archivado\` timestamp NULL`);
        await queryRunner.query(`ALTER TABLE \`notificaciones\` CHANGE \`usuario_id\` \`usuario_id\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`JUSTIFICACIONES\` CHANGE \`fecha_de_justificacion\` \`fecha_de_justificacion\` text NULL`);
        await queryRunner.query(`ALTER TABLE \`JUSTIFICACIONES\` CHANGE \`documentos_adjuntos\` \`documentos_adjuntos\` text NULL`);
        await queryRunner.query(`ALTER TABLE \`JUSTIFICACIONES\` CHANGE \`observaciones_admin\` \`observaciones_admin\` text NULL`);
        await queryRunner.query(`ALTER TABLE \`JUSTIFICACIONES\` CHANGE \`id_auxiliar\` \`id_auxiliar\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`JUSTIFICACIONES\` CHANGE \`id_administrador\` \`id_administrador\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`JUSTIFICACIONES\` CHANGE \`id_director\` \`id_director\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`ASISTENCIA_EXTRA\` CHANGE \`hora_de_llegada\` \`hora_de_llegada\` time NULL`);
        await queryRunner.query(`ALTER TABLE \`ASISTENCIA_EXTRA\` CHANGE \`hora_salida\` \`hora_salida\` time NULL`);
        await queryRunner.query(`ALTER TABLE \`ASISTENCIA_EXTRA\` CHANGE \`observaciones\` \`observaciones\` text NULL`);
        await queryRunner.query(`ALTER TABLE \`ASISTENCIA\` CHANGE \`hora_de_llegada\` \`hora_de_llegada\` time NULL`);
        await queryRunner.query(`ALTER TABLE \`ASISTENCIA\` CHANGE \`hora_salida\` \`hora_salida\` time NULL`);
        await queryRunner.query(`ALTER TABLE \`ASISTENCIA\` CHANGE \`fecha\` \`fecha\` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE \`ESTADO_ALUMNO\` CHANGE \`observacion\` \`observacion\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`ESTADO_ALUMNO\` CHANGE \`fecha_actualizacion\` \`fecha_actualizacion\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE \`ausencias_masivas_programadas\` CHANGE \`observaciones\` \`observaciones\` text NULL`);
        await queryRunner.query(`ALTER TABLE \`ausencias_masivas_log\` CHANGE \`hora_programada\` \`hora_programada\` time NULL`);
        await queryRunner.query(`ALTER TABLE \`ausencias_masivas_log\` CHANGE \`hora_fin\` \`hora_fin\` time NULL`);
        await queryRunner.query(`ALTER TABLE \`ausencias_masivas_log\` CHANGE \`observaciones\` \`observaciones\` text NULL`);
        await queryRunner.query(`ALTER TABLE \`ausencias_masivas_log\` CHANGE \`duracion_segundos\` \`duracion_segundos\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`actualizaciones_asistencia\` CHANGE \`accion_realizada\` \`accion_realizada\` varchar(100) NULL`);
        await queryRunner.query(`ALTER TABLE \`actualizaciones_asistencia\` CHANGE \`id_asistencia\` \`id_asistencia\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`actualizaciones_asistencia\` CHANGE \`id_alumno\` \`id_alumno\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`actualizaciones_asistencia\` CHANGE \`id_auxiliar\` \`id_auxiliar\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`actualizaciones_asistencia\` CHANGE \`id_administrador\` \`id_administrador\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`actualizaciones_asistencia\` CHANGE \`id_director\` \`id_director\` varchar(36) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`actualizaciones_asistencia\` CHANGE \`id_director\` \`id_director\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`actualizaciones_asistencia\` CHANGE \`id_administrador\` \`id_administrador\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`actualizaciones_asistencia\` CHANGE \`id_auxiliar\` \`id_auxiliar\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`actualizaciones_asistencia\` CHANGE \`id_alumno\` \`id_alumno\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`actualizaciones_asistencia\` CHANGE \`id_asistencia\` \`id_asistencia\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`actualizaciones_asistencia\` CHANGE \`accion_realizada\` \`accion_realizada\` varchar(100) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`ausencias_masivas_log\` CHANGE \`duracion_segundos\` \`duracion_segundos\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`ausencias_masivas_log\` CHANGE \`observaciones\` \`observaciones\` text NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`ausencias_masivas_log\` CHANGE \`hora_fin\` \`hora_fin\` time NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`ausencias_masivas_log\` CHANGE \`hora_programada\` \`hora_programada\` time NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`ausencias_masivas_programadas\` CHANGE \`observaciones\` \`observaciones\` text NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`ESTADO_ALUMNO\` CHANGE \`fecha_actualizacion\` \`fecha_actualizacion\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`ESTADO_ALUMNO\` CHANGE \`observacion\` \`observacion\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`ASISTENCIA\` CHANGE \`fecha\` \`fecha\` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`ASISTENCIA\` CHANGE \`hora_salida\` \`hora_salida\` time NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`ASISTENCIA\` CHANGE \`hora_de_llegada\` \`hora_de_llegada\` time NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`ASISTENCIA_EXTRA\` CHANGE \`observaciones\` \`observaciones\` text NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`ASISTENCIA_EXTRA\` CHANGE \`hora_salida\` \`hora_salida\` time NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`ASISTENCIA_EXTRA\` CHANGE \`hora_de_llegada\` \`hora_de_llegada\` time NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`JUSTIFICACIONES\` CHANGE \`id_director\` \`id_director\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`JUSTIFICACIONES\` CHANGE \`id_administrador\` \`id_administrador\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`JUSTIFICACIONES\` CHANGE \`id_auxiliar\` \`id_auxiliar\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`JUSTIFICACIONES\` CHANGE \`observaciones_admin\` \`observaciones_admin\` text NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`JUSTIFICACIONES\` CHANGE \`documentos_adjuntos\` \`documentos_adjuntos\` text NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`JUSTIFICACIONES\` CHANGE \`fecha_de_justificacion\` \`fecha_de_justificacion\` text NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`notificaciones\` CHANGE \`usuario_id\` \`usuario_id\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`notificaciones\` CHANGE \`fecha_archivado\` \`fecha_archivado\` timestamp NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`notificaciones\` CHANGE \`fecha_lectura\` \`fecha_lectura\` timestamp NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`notificaciones\` CHANGE \`fecha_creacion\` \`fecha_creacion\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`notificaciones\` DROP COLUMN \`detalles\``);
        await queryRunner.query(`ALTER TABLE \`notificaciones\` ADD \`detalles\` longtext CHARACTER SET "utf8mb4" COLLATE "utf8mb4_bin" NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`notificaciones\` CHANGE \`icono\` \`icono\` varchar(50) NULL DEFAULT 'NULL'`);
